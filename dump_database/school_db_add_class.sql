...
DROP TABLE IF EXISTS `add_class`;
...
LOCK TABLES `add_class` WRITE;
/*!40000 ALTER TABLE `add_class` DISABLE KEYS */;
INSERT INTO `add_class` VALUES (1,1,'FY',20000),(2,1,'SY',30000),(3,1,'TY',30000),(4,1,'LY',40000);
/*!40000 ALTER TABLE `add_class` ENABLE KEYS */;
UNLOCK TABLES;
